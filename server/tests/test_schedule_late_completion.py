...
class ScheduleLateCompletionTest(unittest.TestCase):
    ...
    def test_reported_delay_shifts_following_task_for_same_assignee(self):
        project = Project(
    ...
    def test_reported_delay_keeps_delay_on_blocked_following_task(self):
        project = Project(
    ...
    def test_reported_delay_keeps_completion_when_following_task_cannot_shift(self):
        project = Project(
